...
function generateRecommendations(healthDetails) {
  ...
  if (healthDetails.toLowerCase().includes("back pain")) {
    recommendations.push(
      "1. Perform gentle stretches to relieve back tension."
    );
    ...
    recommendations.push(
      "1. Engage in low-impact activities like swimming or cycling."
    );
    recommendations.push(
      "2. Strengthen the muscles around the knee with specific exercises."
    );
    recommendations.push("3. Avoid high-impact activities such as running.");
  } else if (healthDetails.toLowerCase().includes("neck pain")) {
    recommendations.push(
      "1. Practice neck stretches and rotations to improve mobility."
    );
    ...
    recommendations.push(
      "1. Perform shoulder stretches to increase flexibility."
    );
    recommendations.push(
      "2. Strengthen shoulder muscles with resistance bands."
    );
    recommendations.push("3. Avoid heavy lifting until pain subsides.");
  } else if (healthDetails.toLowerCase().includes("hip pain")) {
    recommendations.push(
      "1. Incorporate hip-opening stretches into your routine."
    );
    recommendations.push(
      "2. Consider physical therapy for targeted exercises."
    );
    recommendations.push("3. Limit activities that exacerbate hip pain.");
  } else {
    recommendations.push(
      "No specific recommendations found. Please consult a professional."
    );
  }
